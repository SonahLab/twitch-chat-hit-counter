...
![](assets/module0/images/google.png)<br>
...
## Objective
![](assets/module0/images/clientserver.svg)<br>

In **Module 0**, you will be implementing HTTP Rest Controllers to handle various **CRUD** (**C**reate **R**ead **U**pdate **D**elete) operations.
...
## File Structure
For `Module 0`, the below file structure are all the relevant files needed.
...
![](assets/module0/images/greetings.svg)<br>
![](assets/module0/images/greetingController.svg)<br>

In `GreetingRestController.java`, implement `sayHello(String name)`.<br>
...
- [ ] Test with:
    ```shell
    ./gradlew test --tests "*" -Djunit.jupiter.tags=Module0
    ```
...
![](assets/module0/images/greetingSwagger.png)<br>
...
## Exercise 2: Game API
![](assets/module0/images/gameAPI.svg)<br>
...
![](assets/module0/images/gameCharacter.png)<br>
...
### Example 1:
> ![](assets/module0/images/takeDamage_50.png)
> 
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 2:
> ![](assets/module0/images/takeDamage_110.png)
> 
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 1:
> ![](assets/module0/images/consumePotion_HP_25.svg)
> 
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 2:
> ![](assets/module0/images/consumePotion_HP_99.svg)
> 
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 3:
> ![](assets/module0/images/consumePotion_MP_25.svg)
> 
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 4:
> ![](assets/module0/images/consumePotion_MP_99.svg)
> 
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 5:
> ![](assets/module0/images/consumePotion_Remove.svg)
> 
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 6:
> ![](assets/module0/images/consumePotion_Error.svg)
>
> **Input**:
> ```java
> GameCharacter character = new GameCharacter();
...
### Example 1:
> ![](assets/module0/images/characterState.svg)
> 
> **Input**:
> ```java
...
![](assets/module0/images/gameController.svg)
...
- [ ] Play around with the **Game API** endpoint(s)
  ![](assets/module0/images/gameSwagger.png)<br>
